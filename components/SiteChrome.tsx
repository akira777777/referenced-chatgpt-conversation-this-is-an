...
export function Footer() { return <footer><div className="container footer-grid"><div><Link href="/" className="logo light"><span>R</span>REFORM</Link><p>Precision care for the technology you rely on.</p><small>{placeholderNotice}</small></div><div><b>Repairs</b><Link href="/repair">Start a repair</Link><Link href="/prices">Prices</Link><Link href="/track">Track repair</Link></div><div><b>Company</b><Link href="/business">Business</Link><Link href="/about">About</Link><Link href="/contact">Contact</Link></div><div><b>Support</b><Link href="/faq">FAQ</Link><span>+420 000 000 000</span><span>hello@example.cz</span><span>Mon–Fri, 9:00–18:00</span></div></div><div className="container footer-bottom"><span>© 2026 Reform — demonstration concept</span><span>Privacy · Terms · CZ / EN</span></div></footer>; }
